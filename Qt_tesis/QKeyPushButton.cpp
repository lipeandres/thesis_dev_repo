...
void QKeyPushButton::mousePressEvent(QMouseEvent * /*event */)
{
	...
	// se si tratta del maiuscolo:
        ...
        if (tmpKeyBoard->isEnabledSwitchingEcho() == true && (IS_PASSWORD(text) == true || IS_PASSWORD_EMB(text) == true))
        ...
        //mouseReleaseEvent(QMouseEvent::MouseButtonRelease event);
}
