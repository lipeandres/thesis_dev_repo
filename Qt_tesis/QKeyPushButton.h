...
#define STYLE_FOCUS_TEXT               "color: black;selection-color: black;border: 0px beige;padding: 2px 8px;background-color: white; selection-background-color: white;selection-color:black;   font: bold 14px;border-style: outset;border-width: 0px;border-radius: 10px;"
//background-color: rgb(160,160,160);border-style: outset;border-width: 2px;border-radius: 10px;border-color: beige; font: bold 14px;min-width: 10em;padding: 6px;





        #define DEFAULT_STYLE_BUTTON		"color:rgb(60, 60, 60);border: 1px solid grey;border-radius:5px;font-weight: bold;font-size:15px;"
