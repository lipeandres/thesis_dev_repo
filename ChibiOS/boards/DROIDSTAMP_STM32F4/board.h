...
#define BOARD_NAME              "DROIDSTAMP STM32F4"
 ...
 * PA9  - UART_TX         (input floating).
 * PA10 - UART_RX       (alternate 10).
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(0) |         \
                                     ...
                                     PIN_MODE_ALTERNATE(0) |     \
                                     PIN_MODE_ALTERNATE(0))
#define VAL_GPIOA_OTYPER            0x00000000   /*0 output push-pull, 1 Open drain*/
#define VAL_GPIOA_OSPEEDR           0xFFFFFFFF   /*100 MHz*/
...
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(9,  7) |              \
                                     PIN_AFIO_AF(10, 7))
/*
 * Port B setup.
 * All input with pull-up except:
