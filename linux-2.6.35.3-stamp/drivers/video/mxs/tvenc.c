...
/* NTSC 720x480 mode */
#define NTSC_X_RES	640 // 720
#define NTSC_Y_RES	480 // 480
		      ...
		      struct mxs_platform_fb_entry *pentry)
{
	...
	if(tvenc_mode==TVENC_MODE_NTSC) {
		printk("init tvenc_ntsc\r\n");
	}

	if(tvenc_mode==TVENC_MODE_PAL) {
		printk("init tvenc_pal\r\n");
	}
