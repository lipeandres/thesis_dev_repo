...
#define PINID_SSP2_DATA0    MXS_PIN_ENCODE(0, 0)
#define PINID_SSP2_DATA1    MXS_PIN_ENCODE(0, 1)
#define PINID_SSP2_DATA2    MXS_PIN_ENCODE(0, 2)
#define PINID_SSP2_DATA3    MXS_PIN_ENCODE(0, 3)
#define PINID_SSP2_CMD      MXS_PIN_ENCODE(0, 20)
#define PINID_SSP2_DETECT   MXS_PIN_ENCODE(0, 19)
#define PINID_SSP2_SCK      MXS_PIN_ENCODE(0, 24)
